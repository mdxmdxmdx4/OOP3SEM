...
namespace lab003
{
    ...
    {
         public static void Sum(this myStack<int> obj)
        {
            int kkk = obj.Count();
            int sum = 0 ;
            for (int i = 0; i < kkk; i++)
        ...
        public static int Difference(this myStack<int> obj)
        {
            int min = 9999;
            int max = 0;
            int leng = obj.Count();
        ...
        public static int CountOfElems(this myStack<int> obj)
        {
            Console.WriteLine("--Сработал метод из статического класса--");
            return obj.Count();
        }

        public static int Middle(this myStack<int> obj)
        {
            int kol = obj.Count();
            int all = 0;
           for(int i =0; i < kol; i++)
